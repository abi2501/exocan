...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.graph_wid = QtWidgets.QFrame(parent=self.main_wid)
        self.graph_wid.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.graph_wid.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.graph_wid.setObjectName("graph_wid")
        self.verticalLayout_2.addWidget(self.graph_wid)
